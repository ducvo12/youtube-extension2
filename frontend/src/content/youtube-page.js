...
export function getCaptionTrackIdentity(urlString) {
  return [
...
export function getCaptionSourceIdentity(urlString) {
  return [
    getCaptionUrlParam(urlString, "v"),
    getCaptionUrlParam(urlString, "lang"),
    getCaptionUrlParam(urlString, "kind"),
...
export function isAutoGeneratedCaptionTrack(track) {
...
export function isTranslatedCaptionTrack(track) {
...
export function getNormalizedCaptionTracksFromPage() {
...
export function createCaptionTrackFromUrl(captionUrl, label) {
...
export function createSourceCaptionTrackFromUrl(captionUrl, sourceLabel) {
  const sourceUrl = getCaptionSourceUrlString(captionUrl);
...
export function getRecommendationsColumn() {
